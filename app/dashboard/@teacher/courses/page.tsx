...
import { useMyCourses } from "@/hooks/courses/use-course";
import Image from "next/image";
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger, SelectValue  } from "@/components/ui/select";
import EmptyComponent from "@/components/empty/Empty";
import { Book, Filter } from "lucide-react";
import LoadingCourses from '../../../(apprenant)/courses/loading';
...
const Page = () => {
  ...
  const { courses, loading, error,getMyCourses } = useMyCourses(appliedFilters);
  ...
  const handleResetFilters = () => {
    ...
    getMyCourses({ ...appliedFilters, page: newPage });
  };
        ...
        {/* Contenu principal */}
              {loading ? (
                ...
                <div className="text-center py-16 bg-white rounded-lg shadow-sm">
                  ...
                  <button
                    onClick={() => getMyCourses(appliedFilters)}
